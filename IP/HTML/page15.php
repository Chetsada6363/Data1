...
$sql = "SELECT Receipt_number, Date, MovieName, UserName, Seat_number, Showtime, QRcode
        FROM ticket";
...
echo "<h3>ตั๋วภาพยนตร์</h3>";
echo "<table>";
echo "<tr><th>เลขที่ใบเสร็จ</th><th>วันที่</th><th>ชื่อภาพยนตร์</th><th>ชื่อลูกค้า</th><th>หมายเลขที่นั่ง</th><th>รอบฉาย</th><th>QR Code</th></tr>";
